...
public class SwiftRefluttersdkPlugin: NSObject, FlutterPlugin,REiosSmartLinkReceiver,REiosNotificationReceiver {
  ...
  public static func register(with registrar: FlutterPluginRegistrar) {
    ...
    @objc
    public static func setCustomNotification(userInfo: [String : Any]){
        REiosHandler.setCustomNotification(userInfo: userInfo)
    }
    @objc
    public static func setNotificationAction(response: UNNotificationResponse){
    ...
    @objc
    public static func handleDynamicLinkWith(userActivity: NSUserActivity, successHandler: @escaping (_ returnData: String) -> (Void), failureHandler: @escaping (_ error: String) -> (Void)) {
